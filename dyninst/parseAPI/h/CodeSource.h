...
class PARSER_EXPORT CodeSource : public Dyninst::InstructionSource {
 ...
 protected:
    ...
    // binpang. add. conditional non-return function. suche error: http://man7.org/linux/man-pages/man3/error.3.html
    // it is a conditional non-return function according to function argument.
    static dyn_hash_map<std::string, bool(*)(Function*, Block*)> conditional_non_returning_funcs;

 public:
    // binpang. add. error conditional non-return function handler.
    static bool conditionalNonReturnError(Function*, Block*);
    static bool isNonReturnForErrorFunc(Function*, Block*);
    virtual bool conditionalNonReturning(Address, Function*, Block*) { return false; }
    bool conditionalNonReturning(std::string, Function*, Block*);
...
class PARSER_EXPORT SymtabCodeSource : public CodeSource, public boost::lockable_adapter<boost::recursive_mutex> {
 ...
 public:
    ...
    bool conditionalNonReturning(Address, Function*, Block*);
