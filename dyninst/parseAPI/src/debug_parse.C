...
int Dyninst::ParseAPI::dyn_debug_conditional_nonreturn = 0;
...
int Dyninst::ParseAPI::conditional_nonreturn_printf_int(const char *format, ...)
{
    if(getenv("DYNINST_DEBUG_CONDITIONAL_NONRETURN"))
            dyn_debug_conditional_nonreturn = 1;
    else
	    return 0;

    if(!dyn_debug_conditional_nonreturn) return 0;
