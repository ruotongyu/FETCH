...
namespace ParseAPI {
    ...
    extern int PARSER_EXPORT conditional_nonreturn_printf_int(const char *format, ...);
    ...
    extern int dyn_debug_conditional_nonreturn;
...
#define conditional_nonreturn_printf(format, args...) do { conditional_nonreturn_printf_int(format, ## args); } while(0)
